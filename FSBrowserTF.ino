...
const char* ssid2 = "stefwlan";
const char* password2 = "donna123";
const char* ssid3 = "iphonecb";
const char* password3 = "donna123";
const char* ssid = "Carsten";
const char* password = "d0nna123";
